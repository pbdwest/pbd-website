...
import svgPaths from "./svg-ds5zfnb0xg";
import imgImage1725 from "figma:asset/9b96a2234469495fb9b751fa993ee0ea4622ebd4.png";
  ...
  return (
    <div className="bg-[#111642] relative size-full" data-name="HeroSection">
      <div className="absolute h-[780px] left-0 top-[79px] w-[1339px]" data-name="Container">
        <div className="absolute h-[780px] left-0 top-0 w-[1339px]" data-name="image 1725">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[115.38%] left-0 max-w-none top-0 w-full" src={imgImage1725} />
          </div>
        </div>
        ...
        <div className="absolute content-stretch flex items-center justify-center left-[665px] top-[34px]" data-name="Paragraph">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22.4px] not-italic relative shrink-0 text-[#d4d4d4] text-[14px] w-[501px]">Power Buying Dealers</p>
        </div>
        ...
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[67.2px] left-[64px] not-italic text-[39px] text-[rgba(255,255,255,0.4)] top-[285px] tracking-[-3.92px] w-[588px]">Power Buying Dealers</p>
      </div>
