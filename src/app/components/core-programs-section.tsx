...
export function CoreProgramsSection() {
  ...
  return (
    <section className="bg-[#fafafa]" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[80px] py-[40px] md:py-[80px] flex flex-col gap-[30px] md:gap-[56px]">
        {/* Header */}
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col lg:flex-row items-start justify-between gap-6">
            ...
            <p
              ...
              style={{ fontSize: isMobile ? "14px" : "16px", fontWeight: 400, lineHeight: 1.5 }}
            >
        ...
        <div className="flex flex-wrap gap-x-[38px] gap-y-[56px]">
          {programs.map(({ color, Icon, name, description, fullWidth }) => (
            <div
              ...
              style={{ width : isMobile ? "clamp(100%, 30%, 401px)" : "clamp(280px, 30%, 401px)" }}
            >
              {/* Icon square */}
